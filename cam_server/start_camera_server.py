...
def start_camera_server(host, port, config_base, hostname=None, port_range=None, mode=0,
...
def main():
    ...
    start_camera_server(arguments.interface, arguments.port, arguments.base, arguments.hostname, None,
