...
def start_camera_manager(host, port, server_config, config_base, scripts_base, client_timeout=None, info_update_timeout=None,
    ...
    proxy = CameraManager(config_manager, user_scripts_manager, server_config,
...
def main():
    ...
    start_camera_manager(arguments.interface, arguments.port, arguments.servers, arguments.base, arguments.scripts_base,
